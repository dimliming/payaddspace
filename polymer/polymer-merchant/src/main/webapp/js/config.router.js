    ...
    [          '$stateProvider', '$urlRouterProvider', 'JQ_CONFIG', 
      function ($stateProvider,   $urlRouterProvider, JQ_CONFIG) {
          ...
          $stateProvider
              ...
              .state('papp.bdm.mymerchant', {
                  url: '/mymerchant',
                  template: '<div ui-view class="fade-in-up" ng-controller="MyMerchantCtrl"></div>'
              })
              .state('papp.bdm.mymerchant.edit', {
                  url: '/edit',
               ...
               .state('papp.bdm.merchantuser', {
                  url: '/mymerchant',
                  template: '<div ui-view class="fade-in-up" ng-controller="MerchantUserCtrl"></div>'
              })
               .state('papp.bdm.merchantuser.edit', {
                  url: '/list',
                  templateUrl: 'tpl/bdm/merchantUser-edit.html',
                  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad){
                    	  
                          return uiLoad.load('js/controllers/bdm/merchantUser.js');
                      }]
                  }
              })
             ...
             .state('papp.bdm.securitycfg.configlist', {
              ...
              .state('papp.account', {
               ...
               .state('papp.account.enquary', {
                  url: '/recharge',
                  template: "<div ui-view class='fade-in-up' ng-controller='AccountCtrl'></div>",            
              })
              
              .state('papp.account.enquary.edit', {
                  url: '/accdetail',
                  templateUrl: 'tpl/bdm/account-edit.html',
                  resolve: {
                      deps: ['uiLoad',
                        function( uiLoad){
                          return uiLoad.load('js/controllers/bdm/account.js');
                      }]
                  }
              })
