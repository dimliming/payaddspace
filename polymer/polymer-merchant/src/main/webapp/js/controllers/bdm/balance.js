...
/* Controllers */
  ...
  // controller
app.controller('BalanceCtrl', ['$scope','$rootScope', '$http','$state', function($scope,$rootScope,$http,$state) {
	...
	$scope.query = function(pageNum) {
		...
		$http.post('balance/list', param,{headers: { "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"}})
