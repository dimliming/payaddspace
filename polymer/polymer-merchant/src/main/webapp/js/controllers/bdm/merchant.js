...
/* Controllers */
  ...
  // controller
app.controller('MyMerchantCtrl', ['$scope','$rootScope', '$http','$state', function($scope,$rootScope,$http,$state) {
    ...
    $scope.edit = function(id){
    		$http.post('myMerchant/load',{headers: { "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"}})
