...
/* Controllers */
  ...
  // controller
app.controller('TradeCtrl', ['$scope','$rootScope', '$http','$state', function($scope,$rootScope,$http,$state) {
	...
	$scope.query = function(pageNum) {
		...
		$http.post('trade/list', param,{headers: { "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"}})
    ...
    $scope.edit = function(id){
    	if (id==undefined){
    		...
    		var param = $.param({tradeNo:id});
    		$http.post('trade/load', param,{headers: { "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"}})
    		.then(function(response) {
    ...
    $scope.save = function(){
    	...
    	$http.post('merchant/save', param,{headers: { "Content-Type": "application/x-www-form-urlencoded; charset=UTF-8"}})
		.then(function(response) {
