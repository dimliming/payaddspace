...
public class MerchantUser {
	...
	//经办权限
	private char authAgency;
	//复核权限
	private char authCheck;
	//建立时间
	...
	public char getAuthAgency() {
		return authAgency;
	}
	public void setAuthAgency(char authAgency) {
		this.authAgency = authAgency;
	}
	public char getAuthCheck() {
		return authCheck;
	}
	public void setAuthCheck(char authCheck) {
