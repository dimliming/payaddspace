...
public class MySqlSessionTemplate implements SqlSession {
    ...
    public MySqlSessionTemplate(SqlSessionFactory sqlSessionFactory, ExecutorType executorType,
        ...
        this.sqlSessionProxy = (SqlSession) Proxy.newProxyInstance(
                ...
                new Class[] { SqlSessionExtend.class }, 
    ...
    public List selectList(MappedStatement ms, Object parameter, ResultHandler handler) {
    	return ((SqlSessionExtend)this.sqlSessionProxy).selectList(ms, parameter, handler);
    }
    /**
     * {@inheritDoc}
     */
    ...
    public List selectList(MappedStatement ms, Object parameter){
    	return ((SqlSessionExtend)this.sqlSessionProxy).selectList(ms, parameter);
    }
    public int update(MappedStatement ms,Object parameter){
    	return ((SqlSessionExtend)this.sqlSessionProxy).update(ms,parameter);
    }
    /**
     * {@inheritDoc}
     */
