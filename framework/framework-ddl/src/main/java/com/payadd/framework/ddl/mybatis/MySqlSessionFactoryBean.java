...
public class MySqlSessionFactoryBean extends SqlSessionFactoryBean {
    ...
    private Resource platformConfigLocation;
    ...
    private SqlSessionFactoryBuilder sqlSessionFactoryBuilder = new MySqlSessionFactoryBuilder();
    ...
    public void setPlatformConfigLocation(Resource platformConfigLocation) {
		this.platformConfigLocation = platformConfigLocation;
	}
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
        ...
        PlatformConfigParser pcp = new PlatformConfigParser(platformConfigLocation.getInputStream());
        ((MyConfiguration)configuration).setEntityMap(pcp.parser());
        ((MyConfiguration)configuration).setPlatformConfigPath(platformConfigLocation.getDescription());
